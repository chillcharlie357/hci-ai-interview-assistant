...
> **文档版本**: v2.1
> **更新日期**: 2026-05-04
> **数据来源**: `spec/stitch_elite_digital_presence/` 目录下的所有设计输出
...
> **注意：** 设计参考文件位于 `spec/stitch_elite_digital_presence/` 目录。

| 目录 | 内容 | 备注 |
|---|---|---|
| ai_9 | AI 面试官瓦片 | 参考数字人头像设计 |
| ai_10 | 招聘端配置页 | 参考 UI 布局 |
| ai_11 | 面试间页面 | 参考 UI 布局 |
| ai_12 | 评价报告页 | 参考 UI 布局 |
| ai_13 - ai_16 | 其他页面 | 参考 UI 布局 |
